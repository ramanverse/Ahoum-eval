...
[![Streamlit App](https://img.shields.io/badge/Streamlit-App-FF4B4B.svg?logo=Streamlit)](http://localhost:8501)
...
```
Open **[http://localhost:8501](http://localhost:8501)** to browse pages:
